            ...
            <AnimatedElement delay={1000}>
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                ...
                <a 
                  ...
                  className="group relative w-16 h-16 bg-gradient-to-r from-gray-800 to-gray-900 rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-2xl hover:shadow-white/25 hover:scale-110 border border-gray-700 hover:border-gray-500"
                >
                  ...
                  <svg className="w-8 h-8 text-white group-hover:text-gray-200 transition-colors duration-300 relative z-10" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group relative w-16 h-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/50 hover:scale-110 border border-blue-500 hover:border-blue-400"
                >
                  ...
                  <svg className="w-8 h-8 text-white group-hover:text-blue-100 transition-colors duration-300 relative z-10" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                  <div className="absolute inset-0 rounded-full bg-blue-400/30 scale-0 group-hover:scale-100 transition-transform duration-500 opacity-0 group-hover:opacity-100"></div>
                </a>
